...
public class Main {
    public static void main(String[] args) {
        ...
        // output : Nama saya adalah ucup, umur saya adalah 17
        ...
        // struktur format = $[argumen_indexs][flags][width][.precision]conversion

        // [argumen_indexs]
        System.out.println("\n[argumen_indexs]");

        System.out.printf("%1$s, wahai %1$s, kemana saja kamu %1$s\n", nama);
        System.out.printf("\numur %1$s berapa?, \n%1$s menjawab: %2$d, wah masih mudanya umurnya %2$d\n", nama, umur);
